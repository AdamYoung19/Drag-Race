...
public class Oppcarselection : MonoBehaviour
{
    [Header("Car Data")]
    ...
    public const string OppSelectedCarPrefKey = "SelectedOpponentCarName"; // Key for PlayerPrefs
    ...
    public void ConfirmSelection()
    {
        if (currentCarIndex >= 0 && currentCarIndex < availableCars.Count)
        {
            ...
            PlayerPrefs.SetString(OppSelectedCarPrefKey, selectedData.name);
